...
- The default script is the `embed.ipxe` menu from the [netboot repository](https://github.com/sky22333/netboot/blob/main/embed.ipxe), shipped as `app/src/main/assets/pxe/autoexec.ipxe` so iPXE fetches it under the name it looks for.
...
| `autoexec.ipxe` | `977b8a4a75b830336129f1538e2b254b113f2ed8d6be60b7f5fc43440ee9de3e` |
